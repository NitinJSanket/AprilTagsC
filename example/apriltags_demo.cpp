...
public:
  ...
  void print_detection(AprilTags::TagDetection& detection) const {
    ...
    cout << "p1: (" << detection.p[0].first << "," << detection.p[0].second << ") "
         << "p2: (" << detection.p[1].first << "," << detection.p[1].second << ") "
         << "p3: (" << detection.p[2].first << "," << detection.p[2].second << ") "
         << "p4: (" << detection.p[3].first << "," << detection.p[3].second << ") ";*/
    cout << detection.id << " " << detection.p[0].first << " " <<  detection.p[0].second
	 << " " << detection.p[1].first << " " <<  detection.p[1].second
	 << " " << detection.p[2].first << " " <<  detection.p[2].second
	 << " " << detection.p[3].first << " " <<  detection.p[3].second << endl;
